...
class ItemKNN(GeneralRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        # Compute item similarity based on content features
        # We treat items as 'users' in ComputeSimilarity because the matrix is |items| x |features|
