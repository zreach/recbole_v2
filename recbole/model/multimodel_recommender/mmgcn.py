...
class MMGCN(ContextRecommender):
    def __init__(self, config, dataset):
        ...
        self.a_dim = self.id2feature.shape[1]
    ...
    def forward(self):
        # representation = None
        representation = self.a_gcn(self.v_feat, self.id_embedding)
    ...
    def calculate_loss(self, interaction):
        ...
        out = self.forward()
        user_embeddings = out["user_id"]  # 用户嵌入
        item_embeddings = out["tracks_id"]  # 物品嵌入
